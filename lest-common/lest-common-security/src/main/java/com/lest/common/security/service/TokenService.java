package com.lest.common.security.service;
...
import com.lest.common.core.utils.uuid.IdUtils;
...
public class TokenService {
    ...
    public Map<String, Object> createToken(LoginUser loginUser) {
        ...
        rspMap.put("access_token", com.lest.common.security.util.JwtUtils.createToken(claimsMap));
    ...
    public LoginUser getLoginUser() {
        String token = SecurityUtils.getToken(ServletUtils.getHttpServletRequest());
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        redisService.setCacheObject(userKey, loginUser, TOKEN_EXPIRE_TIME);
    }
