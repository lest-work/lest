  ...
  <ele-page :multi-card="false">
    <div class="user-wrapper">
      ...
      >
        <template #header>
          <ele-tabs
            ...
            :items="[
              ...
              { name: 'wakapi', label: '编码统计' },
              { name: 'wakapi-config', label: 'WakAPI 配置' }
            ]"
          />
        </template>
        <user-form
        ...
        <div v-if="active === 'wakapi'" class="wakapi-tab">
          <coding-stats-card />
          <activity-heatmap />
          <heartbeat-stream />
        </div>
        <div v-if="active === 'wakapi-config'" class="wakapi-tab">
          <api-key-panel />
        </div>
      </ele-card>
    </div>
...
<script lang="ts" setup>
  ...
  import CodingStatsCard from './components/coding-stats-card.vue';
  import ActivityHeatmap from './components/activity-heatmap.vue';
  import HeartbeatStream from './components/heartbeat-stream.vue';
  import ApiKeyPanel from './components/api-key-panel.vue';
