...
<template>
  ...
  >
    ...
    <div v-if="tabActive === 'theme'" class="setting-wrapper">
      ...
      <!-- 圆角主题 -->
      <div class="setting-item">
        <div class="setting-item-title">开启圆角主题</div>
      ...
      <el-divider />
      <!-- 导航布局 -->
      <ele-text type="placeholder" class="setting-title">导航模式</ele-text>
      ...
      <!-- 侧栏菜单布局 -->
      <div class="setting-item">
        <div class="setting-item-title">侧栏双排菜单</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
            :disabled="layout === 'top'"
      ...
      <!-- 双侧栏二级风格 -->
      <div class="setting-item">
        <div class="setting-item-title">暗色二级侧栏</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
      ...
      <!-- 混合菜单分割 -->
      <div class="setting-item">
        <div class="setting-item-title">混合菜单分割</div>
      ...
      <el-divider />
      <ele-text type="placeholder" class="setting-title">更多配置</ele-text>
      <!-- 固定主体 -->
      <div class="setting-item">
        <div class="setting-item-title">内容区域滚动</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
      ...
      <div class="setting-item hidden-xs-only">
        <div class="setting-item-title">Logo置于顶栏</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
      ...
      <!-- 侧栏排它展开 -->
      <div class="setting-item">
        <div class="setting-item-title">侧栏排它展开</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
      ...
      <el-divider />
      <ele-text type="placeholder" class="setting-title">页签配置</ele-text>
      <!-- 页签 -->
      <div class="setting-item">
      ...
      <!-- 固定主页页签 -->
      <div class="setting-item">
        <div class="setting-item-title">固定主页页签</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
            :disabled="!tabBar"
      ...
      <!-- 页签置于顶栏 -->
      <div class="setting-item">
        <div class="setting-item-title">页签置于顶栏</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
            :disabled="!tabBar"
      ...
      <!-- 页签显示图标 -->
      <div class="setting-item">
        <div class="setting-item-title">页签显示图标</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
            :disabled="!tabBar"
      ...
      <!-- 刷新保留页签 -->
      <div class="setting-item">
        <div class="setting-item-title">刷新保留页签</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
            :disabled="!tabBar"
      ...
      <div class="setting-item">
        ...
        <div class="setting-item-control" style="width: 90px">
          ...
          >
            ...
            <el-option value="indicator" label="圆点" />
            <el-option value="tag" label="标签" />
            <el-option value="button" label="卡片" />
          </el-select>
        </div>
      </div>
      <el-divider />
      <ele-text type="placeholder" class="setting-title">其它配置</ele-text>
      <!-- 切换路由是否缓存 -->
      <div class="setting-item">
        <div class="setting-item-title">页面切换缓存</div>
        <div class="setting-item-control">
          <el-switch
            size="small"
      ...
      <!-- 切换动画 -->
      <div class="setting-item">
        <div class="setting-item-title">路由切换动画</div>
        <div class="setting-item-control" style="width: 110px">
          <el-select
            ...
            :popper-options="{ strategy: 'fixed' }"
          >
            <el-option value="slide-right" label="滑动消退" />
            <el-option value="slide-bottom" label="底部消退" />
            <el-option value="zoom-in" label="放大渐变" />
            <el-option value="zoom-out" label="缩小渐变" />
    ...
    <div v-else-if="tabActive === 'layout'" class="setting-wrapper">
      ...
      <div class="setting-layout-list">
        ...
        >
          ...
          <div class="setting-layout-item-label">{{ item.name }}</div>
        </div>
      </div>
    </div>
    <div v-else-if="tabActive === 'skin'" class="setting-wrapper">
      ...
      <div class="setting-skin-list">
        ...
        >
          ...
          ></div>
          <div class="setting-skin-item-label">{{ item.name }}</div>
        </div>
        <div
        ...
        >
          ...
          <div class="setting-skin-item-label">自定义</div>
        </div>
      </div>
      <!-- 自定义皮肤背景 -->
      <template v-if="showUserSkin">
        <div class="setting-item">
          <div class="setting-item-title">页面背景图片</div>
          <div class="setting-item-control">
            <el-upload
              action=""
              accept="image/*"
        ...
        <div class="setting-item">
          <div class="setting-item-title">页面背景蒙层</div>
          <div class="setting-item-control">
            <el-color-picker
              :show-alpha="true"
        ...
        <div class="setting-item">
          <div class="setting-item-title">顶栏背景颜色</div>
          <div class="setting-item-control">
            <el-color-picker
              :show-alpha="true"
        ...
        <div class="setting-item">
          <div class="setting-item-title">侧栏背景颜色</div>
          <div class="setting-item-control">
            <el-color-picker
              :show-alpha="true"
        ...
        <div class="setting-item">
          <div class="setting-item-title">卡片背景颜色</div>
          <div class="setting-item-control">
            <el-color-picker
              :show-alpha="true"
        ...
        <div class="setting-item">
          <div class="setting-item-title">弹框背景图片</div>
          <div class="setting-item-control">
            <el-upload
              action=""
              accept="image/*"
        ...
        <div class="setting-item">
          <div class="setting-item-title">弹框背景蒙层</div>
          <div class="setting-item-control">
            <el-color-picker
              :show-alpha="true"
        ...
        <!-- 自定义暗黑模式皮肤背景 -->
        <el-divider />
        <ele-text type="placeholder" class="setting-title">暗黑模式</ele-text>
        <div class="setting-item">
          <div class="setting-item-title">页面背景图片</div>
          <div class="setting-item-control">
            <el-upload
