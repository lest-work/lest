...
public class MilestoneController {
    ...
    public Result<PageResult<Long>> getIterations(@PathVariable Long id) {
        return Result.ok(PageResult.of(milestoneService.getIterationIds(id), (long) milestoneService.getIterationIds(id).size(), 1, (int) Math.min(milestoneService.getIterationIds(id).size(), 100)));
    }
}
