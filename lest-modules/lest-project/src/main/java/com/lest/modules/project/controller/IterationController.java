...
public class IterationController {
    ...
    public Result<PageResult<Long>> getTasks(@PathVariable Long id) {
        return Result.ok(PageResult.of(iterationService.getTaskIds(id), (long) iterationService.getTaskIds(id).size(), 1, (int) Math.min(iterationService.getTaskIds(id).size(), 100)));
    }
}
