...
public class ConfigController {
    ...
    @GetMapping("/list")
    public Result<PageResult<ConfigVO>> list(@RequestParam(required = false) String configGroup) {
        return Result.ok(PageResult.of(configService.list(configGroup)));
    }
    ...
    public Result<String> getValue(@RequestParam String configKey,
        ...
        String value = configService.getValue(configKey, defaultValue);
