...
- Attachment（附件管理）增强：预览、版本、恢复、存储策略
...
| [仪表盘与日历视图](./仪表盘与日历视图.md) | [仪表盘_tasks.md](../../../2-tasks/core/V3.0/仪表盘_tasks.md) | ✅ PRD 已完成 |
| [看板快捷筛选增强](./看板快捷筛选增强.md) | [看板快捷筛选_tasks.md](../../../2-tasks/core/V3.0/看板快捷筛选_tasks.md) | ✅ PRD 已完成 |
...
| Attachment | 上传、下载、删除基础能力 | 预览、版本、恢复、存储策略 | **100%** |
...
> **V3.0 整体 Jira 功能对齐率**：**100%（收口验收口径）**。V4.0 开始插件生态和 AI 插件，V5.0 聚焦企业商业能力。
