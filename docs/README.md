...
| **V3.0** | 企业协作增强 | 中国特色：IM 集成、审批流、Portfolio、OKR |
...
2026年8月发布           2026年底              2027年中              2027-2028年           2028年
│                       │                      │                      │                      │
...
| **V3.0** | 2027年中 | 企业微信/钉钉/飞书深度集成、审批流、Portfolio多项目治理、OKR目标管理、国产数据库优化 | 中大型企业 | ✅ MIT + 🔒 |
...
>
> **历史说明**：旧版文档结构（`PRD/`、`TASKS/`、`guide/`、`reference/`）已迁移到上方新结构中，路径变更对应关系：
> - `PRD/` → `1-prd/`
> - `TASKS/` → `2-tasks/`
> - `guide/` → `3-guide/`
...
| [项目管理](./1-prd/core/V1.0/项目管理.md) | V1.0 + **V2.0** | Jira Project | V1.0 完成 |
| [任务管理](./1-prd/core/V1.0/任务管理.md) | V1.0 + **V2.0** | Jira Issue + Workflow | V1.0 完成 |
...
| [CI持续集成](./1-prd/plugins/V1.0/lest-cicd.md) | V1.0 → **插件** | Jira CI/CD | V1.0 完成 |
| [敏捷会议](./1-prd/plugins/V1.0/lest-meeting.md) | V1.0 → **插件** | Jira Meetings | V1.0 完成 |
| [团队绩效](./1-prd/plugins/V1.0/lest-report.md) | V1.0 → **插件** | Jira Reports | V1.0 完成 |
| [发布管理](./1-prd/plugins/V1.0/lest-release.md) | V1.0 → **插件** | Jira Releases | V1.0 完成 |
| [AI服务](./1-prd/plugins/V1.0/lest-ai.md) | V1.0 → **插件** | Jira AI | V1.0 完成 |
| [WakaTime集成](./1-prd/plugins/V1.0/lest-wakatime.md) | V1.0 → **插件** | IDE Activity Tracker | V1.0 完成 |
...
|------|---------|------|-----------|------|
| [任务管理 V3.0](./1-prd/core/V3.0/任务管理.md) | Jira Issue + Automation | 补全 Issue Link/附件/时间追踪/子任务/自动化执行引擎/回收站 | **95%** | 规划中 |
| [敏捷看板增强](./1-prd/core/V3.0/敏捷看板增强.md) | Jira Board + Reports | 泳道/WIP/燃尽图/CFD/Velocity/Control Chart/容量/史诗进度 | **100%** | 规划中 |

#### Plugin 插件层 -- V3.0

| 文档 | 说明 | 状态 |
|------|------|------|
| [V3.0 插件总览](./1-prd/plugins/V3.0/README.md) | OKR、Portfolio、审批流、LDAP、SSO、多租户（6 个新插件） | 规划中 |
