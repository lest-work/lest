...
public class SpringDocConfig implements InitializingBean
{
    ...
    public void afterPropertiesSet()
    {
        ...
        swaggerDocRegister.refreshSwaggerUrls();
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent>
{
    ...
    private final static String[] INCLUDE_ROUTES = new String[] { "lest-system", "lest-job" };
    ...
    public void refreshSwaggerUrls()
    {
        Set<AbstractSwaggerUiConfigProperties.SwaggerUrl> swaggerUrlSet = discoveryClient.getServices()
            ...
            .filter(instance -> StringUtils.equalsAnyIgnoreCase(instance.getServiceId(), INCLUDE_ROUTES))
            .map(instance -> {
                AbstractSwaggerUiConfigProperties.SwaggerUrl swaggerUrl = new AbstractSwaggerUiConfigProperties.SwaggerUrl();
                swaggerUrl.setName(instance.getServiceId());
                swaggerUrl.setUrl(String.format("/%s/v3/api-docs", instance.getServiceId().replaceFirst("^lest-", "")));
                return swaggerUrl;
            })
