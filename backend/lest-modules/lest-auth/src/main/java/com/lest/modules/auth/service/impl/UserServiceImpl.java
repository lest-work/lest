...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public PageResult<UserVO> page(Integer page, Integer size, String username, String phone,
    ...
    private UserVO convertToVO(SysUser user) {
        ...
        String[] roleIdStrs = roleIds.stream().map(String::valueOf).toArray(String[]::new);
