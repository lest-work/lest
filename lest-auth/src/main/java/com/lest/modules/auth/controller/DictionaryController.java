...
public class DictionaryController {
    ...
    /**
     * 查询所有字典列表（统一返回 PageResult 格式）
     */
    @GetMapping
    public Result<PageResult<DictionaryVO>> listAll() {
        List<DictionaryVO> all = dictionaryService.listAll();
        return Result.ok(PageResult.of(all));
    }
